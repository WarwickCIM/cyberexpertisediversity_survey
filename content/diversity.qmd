...
Respondents' concerns with the overplayed 'technology centric' aspects of cyber security raises a broader issue with the technology and EDI agenda. The goal of increasing the representation of women in technology jobs has motivated campaigns to draw more women into STEM subjects at university. There is no doubt that this has been highly valuable. But there is an implicit narrative here that is not necessarily helpful, a message that social scientific and humanities skills are not relevant to technology jobs. Changing the narrative to emphasise the contribution of the social sciences and humanities within tech and within cyber security may be needed, especially as AI technologies change skillsets. To do this effectively it will be necessary to see better representation of these forms of expertise in professional classifications.

## Recommendations

Future studies of expertise diversity in cyber security should be designed in ways that test the boundaries of CyBOK (or other classifications) in order that they can inform future iterations of these frameworks. Future CyBOK should better represent the contribution of the humanities and social sciences to cyber security.
